...
public class FilterFileManager {
    ...
    private final static Logger logger = LoggerFactory.getLogger(FilterFileManager.class);
    ...
    /**
     * puts files into the FilterLoader. The FilterLoader will only add new or
     * changed filters
     *
